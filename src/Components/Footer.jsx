...
const Footer = () => {
  return (
    <div className="w-full h-[110vh] bg-zinc-900 text-white font-grotesk p-20 flex">
      <div className="left-section w-1/2  flex flex-col justify-between">
        <div className="headings ">
          <h1 className="text-[8vw] leading-[14vh] uppercase ">Eye-</h1>
          <h1 className="text-[8vw] leading-[14vh] uppercase ">Opening</h1>
        </div>
        <div className="logo">
          <svg
            width="72"
      ...
      <div className="right-section w-1/2">
        <div>
          <h1 className=" text-[8vw] leading-none uppercase">Presentations</h1>
        </div>

        <div className="mt-4 flex flex-col text-lg font-montreal w-20">
          <p>S:</p>
          <div className="flex flex-col  mt-4">
            <a href="https://www.instagram.com/verma.jatin_05/" className="relative group" >
              Instagram
              {style}{" "}
            </a>
            <a href="https://www.linkedin.com/in/jatin-verma-58198b2a8/" className="relative group">
              Behance
              {style}
            </a>
        ...
        <div className="mt-2 flex justify-between items-center text-lg font-montreal">
          <div>
            <p>S:</p>
            <div className="flex flex-col  mt-4">
              <a href="/" className="relative group">
              ...
              <a href="/" className="relative group">30 Chukarina St {style}</a>
              <a href="/" className="relative group">Lviv, Ukraine {style}</a>
            </div>
          </div>
          ...
          <div>
            <p>S:</p>
            <div className="flex flex-col  mt-4">
              <a href="/" className="relative group">Home {style}</a>
              <a href="/" className="relative group">Services {style}</a>
              <a href="/" className="relative group">Our work {style} </a>
              <a href="/" className="relative group">About us {style}</a>
              <a href="/" className="relative group">Insights {style}</a>
              <a href="/" className="relative group">Contact us {style}</a>
            </div>
          </div>
        </div>

        <div className="copyrightsection flex justify-between items-center mt-8 font-montreal">
          <h1 className="text-[#C5C5C5] font-montreal">
            © ochi design 2025. Legal Terms
          </h1>
          <h1 className="text-[#C5C5C5] font-montreal">Website by Jatin</h1>
        </div>
      </div>
    </div>
  );
